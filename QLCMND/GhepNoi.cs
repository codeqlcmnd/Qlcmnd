...
namespace QLCMND
{
    public partial class GhepNoi : Form
    {
        public GhepNoi(IMatcher matcher, IResourceProvider resourceProvider, string resourcePath, string MatchingAlgorithm, DataTable fingertable)
        {
            InitializeComponent();
